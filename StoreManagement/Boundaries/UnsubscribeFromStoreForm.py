from StoreManagement.Interactors.UnsubscribeFromStoreControl import UnsubscribeFromStoreControl
...
class SubscribeToStoreForm:
    ...
    _control: UnsubscribeFromStoreControl = None
    _storeID: int = None
    _valid: bool = False
    ...
    def submit(self):
        ...
        try:
            control = UnsubscribeFromStoreControl(self._storeID)
            control.execute()
