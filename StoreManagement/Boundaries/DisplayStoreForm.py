from StoreManagement.Interactors.DisplayStoreControl import DisplayStoreControl


class DisplayStoreForm:
    """ invariants:
    """

    _control: DisplayStoreControl = None
    _storeID: int = None
    _valid: bool = False
    ...
    def submit(self):
        ...
        try:
            control = DisplayStoreControl(self._storeID)
            store = control.execute()
