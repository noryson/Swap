from StoreManagement.Interactors.DeactivateStoreControl import DeactivateStoreControl


class DeactivateStoreForm:
    """ invariants:
    """

    _control: DeactivateStoreControl = None
    _storeID: int = None
    _valid: bool = False
    ...
    def submit(self):
        ...
        try:
            control = DeactivateStoreControl(self._storeID)
            control.execute()
