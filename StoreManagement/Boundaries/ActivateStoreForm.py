from StoreManagement.Interactors.ActivateStoreControl import ActivateStoreControl


class ActivateStoreForm:
    """ invariants:
    """

    _control: ActivateStoreControl = None
    _storeID: int = None
    _valid: bool = False
    ...
    def submit(self):
        ...
        try:
            control = ActivateStoreControl(self._storeID)
            control.execute()
